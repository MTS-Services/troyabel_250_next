...
//   // --- THIS IS THE FIX ---
//   // We'll store the Hero section's height to use as our trigger point.
//   const [heroHeight, setHeroHeight] = useState(0);

//   useEffect(() => {
//     // On component mount, find the hero section and set its height.
...
//     // We now check if the scroll position is past the bottom of the hero section.
//     // The "- 80" provides a small buffer for a smoother transition.
//     if (heroHeight > 0) {
...
//         <div className='w-28 hover:animate-spin inline-block '>
//           {' '}
...
//               src='/image/logo/logophone.png'
//               alt='logo'
//               className='h-8 w-auto hover:animate-spin inline-block'
//             />
//           ) : (
//             <img
//               src='/image/logo/logodesktop.png'
...
//       >
//         <div className='flex w-full flex-row items-center justify-between px-2'>
//           {/* --- THIS IS THE UPDATED MOBILE LOGO SECTION --- */}
//           {isScrolled ? (
//             <img
//               src='/image/logo/logophone.png'
//               alt='logo'
