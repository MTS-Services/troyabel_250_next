...
const InfoModal = ({ isOpen, setIsEditModalOpen }) => {
      ...
      >
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-[460px] border-r mt-16 mb-20 border-gray-200 flex flex-col items-center justify-center p-8 text-center">
            ...
            />
            <h2 className="text-xl font-semibold text-black mb-2">Dr. Troy Abel</h2>
            ...
            <div className="flex flex-col gap-5 text-[#6D6D6D] text-sm items-start w-full">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg">Wednesday, September 3, 2025, 2:00 am</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="flex-1 flex flex-col">
            <div className="flex-1 justify-center items-center overflow-y-auto p-6 space-y-6">
              ...
              <div>
                <label className="block mt-2 text-[#6D6D6D] font-semibold text-[18px] mb-4">
                  What's the #1 thing you're hoping to get out of our conversation?
                </label>
                <textarea
                  name="goal"
                  value={formData.goal}
              ...
              <div>
                <label className="block text-[#6D6D6D] font-semibold text-[18px] mb-4">
                  Which area of UX are you most interested in? (e.g., UX/UI Design, UX Research, UX Strategy, I'm still figuring it out!)
                </label>
                <textarea
                  name="interest"
            ...
            <div className="flex justify-between items-center bg-white">
              <p className="text-md text-gray-500 mt-4 px-6">
                ...
                <span className="cursor-pointer text-purple-600 underline">Terms</span> and{" "}
                <span className="cursor-pointer text-purple-600 underline">Privacy Policy</span>.
              </p>
            </div>
